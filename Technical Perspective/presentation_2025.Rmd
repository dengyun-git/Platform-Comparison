...
DEL_Sample <-  read.csv(paste0(inputPath, "oxf-qc2-als-mass-spectometry-wb-genial-hazelnut-7025/Data/output/BEADdel/SAMPLE/ProDat_QCed.csv"), row.names=1)

NON_Sample <- read.csv(paste0(inputPath,"oxf-qc2-als-mass-spectometry-wb-genial-hazelnut-7025/Data/output/NONdel/SAMPLE/ProDat_QCed.csv"), row.names=1)
